...
const Banner = () => {
  ...
  const downloadPDF = () => {
    ...
    iframe.onload = () => {
      ...
      downloadLink.download = "resume_of_anfal.pdf";
        ...
        >
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-lg mb-6">
              ...
              and MongoDB. */}
              DevOps Engineer: CI/CD, Docker, Kubernetes, IaC using Terraform,
              Ansible, AWS, Azure, GCP proficiency for seamless deployment and
              management.
            </p>
            <button
              onClick={downloadPDF}
