    ...
    return (
      <div className="max-w-[1520px] mx-auto py-8 px-4 mt-48 mb-20">
        ...
        <div className="border border-gray-200 p-4 rounded">
          <h3 className="text-lg font-extrabold mb-2">DevOps Engineer (Hybrid) at Red Technologies Limited</h3>
          <p className="text-gray-700 mb-2 font-bold">February 2024 - July 2025</p>
          <p className="text-gray-700 mb-2 font-semibold">Location: Baridhara, Dhaka</p> 
