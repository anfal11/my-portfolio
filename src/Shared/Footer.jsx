      ...
      <footer className="bg-gradient-to-r from-gray-100 via-[#d1d1d1] to-gray-100">
        <div className="flex flex-wrap justify-between max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              {/* <img
                ...
                alt="Anfal.Code logo"
              /> */}
              <h1 className="text-4xl font-bold"> Anfal.Code</h1>
              ...
              <div className="flex mt-8 space-x-6 text-gray-700">
                ...
                <a
                  ...
                  href="https://www.facebook.com/beastslayerfiend.12/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="hover:opacity-75"
                  href="https://www.instagram.com/anfal_ratul/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="hover:opacity-75"
                  href="https://twitter.com/RatulAnfal"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-700">
                  <a
                    className="hover:opacity-75"
                    href="https://blog.Anfal.Code"
                  >
                    Blog
                  </a>
                  <a
                    className="hover:opacity-75"
                    href="https://courses.Anfal.Code"
                  >
                    Courses
                  </a>
                  <a
                    className="hover:opacity-75"
                    href="https://tutorials.Anfal.Code"
                  >
                    Tutorials
                  </a>
                </nav>
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-700">
                  ...
                  <a
                    className="hover:opacity-75"
                    href="mailto:ratulcse1@gmail.com"
                  >
                    Email Me
                  </a>
                </nav>
          ...
          <p className="mt-8 text-xs text-gray-800">
            © 2023 Anfal.Code. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
